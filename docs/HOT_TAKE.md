...
The useful unit of assurance is therefore not “formula changed.” It is a **witness**: a cited rule, a discriminating input, an observed divergence, a dependency path, a minimal patch, and an accountable approval. ClauseGrid makes that chain executable and reviewable.
